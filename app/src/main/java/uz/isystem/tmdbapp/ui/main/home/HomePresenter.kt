...
class HomePresenter(val view: HomeMVP.View) : HomeMVP.Presenter {
    ...
    override fun loadTopRated() {
        val disposable = movieService.getTopRatedMovies(ApiClientModule.apiKey, 1)
            .observeOn(AndroidSchedulers.mainThread())
            .subscribeOn(Schedulers.io())
            .subscribeWith(object :
    ...
    override fun loadPopular() {
        val disposable = movieService.getPopularMovies(ApiClientModule.apiKey, 1)
            .observeOn(AndroidSchedulers.mainThread())
            .subscribeOn(Schedulers.io())
            .subscribeWith(object :
    ...
    override fun loadNowPlaying() {
        val disposable = movieService.getNowPlayingMovies(ApiClientModule.apiKey, 1)
            .observeOn(AndroidSchedulers.mainThread())
            .subscribeOn(Schedulers.io())
            .subscribeWith(object :
    ...
    override fun loadUpcomingData() {
        val disposable = movieService.getUpcomingMovies(ApiClientModule.apiKey, 1)
            .observeOn(AndroidSchedulers.mainThread())
            .subscribeOn(Schedulers.io())
            .subscribeWith(object :
